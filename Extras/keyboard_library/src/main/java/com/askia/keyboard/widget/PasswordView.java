...
import com.askia.keyboard.adapter.KeyBoardAdapter;
...
public class PasswordView extends RelativeLayout {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position < 11 && position != 9) {    //点击0~9按钮
                    Log.d("Askia", "currentIndex:" + currentIndex);
    ...
    public void setPayMoney(String money) {
        ...
        ((TextView) findViewById(R.id.textAmount)).setText("￥" + money);
    }

    //设置手续费
    public void setPoundage(String poundage) {
        ((TextView) findViewById(R.id.textShouxuFei)).setText(poundage);
    }

    //是否显示额外金额
    public void setExtrasMoneyLayoutHidden(boolean isHidden) {
//        if (isHidden) {
//            findViewById(R.id.tv_extra_money_layout).setVisibility(GONE);
//        } else {
//            findViewById(R.id.tv_extra_money_layout).setVisibility(VISIBLE);
//        }
