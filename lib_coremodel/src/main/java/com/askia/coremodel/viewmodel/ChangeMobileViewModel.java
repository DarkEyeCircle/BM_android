...
public class ChangeMobileViewModel extends ViewModel {
    ...
    private MutableLiveData<BaseResponseData> modifyMoileLiveData = new MutableLiveData<>();
    ...
    public MutableLiveData<BaseResponseData> getModifyMoileLiveData() {
        return modifyMoileLiveData;
    }
    ...
    public void senSmsCode() {
        ...
        GankDataRepository.SendSmsForChangeMobile(pageData)
    ...
    public void checkMobile() {
        if (!NetUtils.isNetConnected()) {
            modifyMoileLiveData.setValue(null);
            return;
        }
        GankDataRepository.CheckOldMobileForChangeMobile(pageData)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .safeSubscribe(new Observer<BaseResponseData>() {
                    @Override
                    ...
                    @Override
                    public void onNext(BaseResponseData responseData) {
                        modifyMoileLiveData.setValue(responseData);
                    }
    ...
    public class PageData {
        ...
        public PageData() {
            ...
            phoneNum.set(RegexUtils.formatPhoneNumToHide(realPhoneNum));
