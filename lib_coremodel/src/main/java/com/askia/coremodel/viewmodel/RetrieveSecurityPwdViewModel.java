...
public class RetrieveSecurityPwdViewModel extends ViewModel {
    ...
    public RetrieveSecurityPwdViewModel() {
    ...
    public void senSmsCode() {
        ...
        GankDataRepository.sendSmsCodeRepositoryForRetrieveSecurityPwd(pageData)
    ...
    public void findBackPayPwd() {
        ...
        GankDataRepository.retrieveSecurityPwd(pageData)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .safeSubscribe(new Observer<BaseResponseData>() {
                    @Override
